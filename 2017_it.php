	...
	<body>
        ...
        <br><br><br>
			...
			<?php
				...
				echo '<tr><td>January</td><td>' . $jan_it_2017 . '</td></tr>';
				echo '<tr><td>February</td><td>' . $feb_it_2017 . '</td></tr>';
				echo '<tr><td>March</td><td>' . $mar_it_2017 . '</td></tr>';
				echo '<tr><td>April</td><td>' . $apr_it_2017 . '</td></tr>';
				echo '<tr><td>May</td><td>' . $may_it_2017 . '</td></tr>';
				echo '<tr><td>June</td><td>' . $jun_it_2017 . '</td></tr>';
				echo '<tr><td>July</td><td>' . $jul_it_2017 . '</td></tr>';
				echo '<tr><td>August</td><td>' . $aug_it_2017 . '</td></tr>';
				echo '<tr><td>September</td><td>' . $sep_it_2017 . '</td></tr>';
				echo '<tr><td>October</td><td>' . $oct_it_2017 . '</td></tr>';
				echo '<tr><td>November</td><td>' . $nov_it_2017 . '</td></tr>';
				echo '<tr><td>December</td><td>' . $dec_it_2017 . '</td></tr>';
				echo '<tr><th>Total</th><th>' . $total_it_2017 . '</th></tr>';
				echo '</table>';
			?>
			</div>
		</div>
